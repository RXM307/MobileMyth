...
Public Class MythDvr28
    Implements iMythDvr

    Private Shared Logger As log4net.ILog = log4net.LogManager.GetLogger(GetType(MythDvr28))
    ...
    Public Function GetConflictList(StartIndex As Integer, Count As Integer, RecordId As Integer) As MythDVR.ProgramList Implements iMythDvr.GetConflictList
        Return DVR.GetConflictList(StartIndex, Count, RecordId)
    End Function
    ...
    Public Function GetRecorded(ChanId As Integer, StartTime As Date, RecordId As Integer) As MythDVR.Program Implements iMythDvr.GetRecorded
        Return DVR.GetRecorded(ChanId, StartTime, RecordId)
    End Function

    Public Function GetUpcomingList(StartIndex As Integer, Count As Integer, ShowAll As Boolean, RecordId As Integer, RecStatus As Integer) As MythDVR.ProgramList Implements iMythDvr.GetUpcomingList
        Return DVR.GetUpcomingList(StartIndex, Count, ShowAll, RecordId, RecStatus)
    End Function

    Public Function RemoveRecorded(ChanId As Integer, StartTs As Date, AllowRerecord As Boolean, ForceDelete As Boolean, RecordId As Integer) As Boolean Implements iMythDvr.RemoveRecorded
